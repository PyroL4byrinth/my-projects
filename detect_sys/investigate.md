...
### 図面との関係をチェック
<img src="./img/miss_drawing.png">
PLCの設定を見ると[ﾃｰﾌﾞﾙ位置決め 下降]はY9B4だが、<br>
図面を見ると、Y9B1に設定されているため、本来の入出力関係が崩れていることが判明した<br>
　→　入出力が正しい場所はうまく出力できていることから、プログラム自体は問題ないと考えている
